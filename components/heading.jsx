    ...
    <header className="px-6 sm:px-8 scroll-smooth">
      <nav className="mx-auto flex lg:max-w-7xl md:max-w-2xl items-center justify-between sm:py-12 py-6 xl:px-8 " aria-label="Global">
        <a href="" className="-m-1.5 p-1.5">
          ...
          <h1 className="text-2xl font-semibold text-yellow-950  group "><span className=''><span className='sm:contents hidden'></span><span className=' group-hover:text-blue-600 transition-all'>Ukrainian</span> <span className='group-hover:text-yellow-400 transition-all'>Book</span> Project</span></h1>
        ...
        <div className="hidden lg:flex lg:gap-x-12">
            ...
            <a href='#members' className="text-md font-semibold tracking-wide leading-6 scroll-smooth text-yellow-950">
                <span className={lora.className}>
                Members <SquareUserRoundIcon className='inline mb-0.5' size={16} />           
                </span>
            </a>
            <a href='#publications' className="text-md font-semibold tracking-wide leading-6 text-yellow-950">
                <span className={lora.className}>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <a href='/' className="text-md font-semibold tracking-wide leading-7 text-yellow-950 -mx-3 block rounded-lg px-3 py-2 text-base">
                    <span>
                        <SquareAsteriskIcon className='inline mr-2' size={16} /> Home       
                    </span>
                </a>
                <button type="button" onClick={() => setMobileMenuOpen(false)}>
                <a href='/#members' className="text-md font-semibold tracking-wide leading-7 scroll-smooth text-yellow-950 -mx-3 block rounded-lg px-3 py-2 text-base">
                    <span>
                        <SquareUserRoundIcon className='inline mr-2' size={16} />  Members          
                    </span>
                </a>
                </button>
                <a href='/#publications' className="text-md font-semibold tracking-wide leading-7 text-yellow-950 -mx-3 block rounded-lg px-3 py-2 text-base">
                    <span>
                        <LibrarySquareIcon className='inline mr-2' size={16} /> Publications        
                    </span>
                </a>
                <a href='/' className="text-md font-semibold tracking-wide leading-7 text-yellow-950 -mx-3 block rounded-lg px-3 py-2 text-base">
                    <span>
                        <ArrowUpRightSquareIcon className='inline mr-2' size={16} /> Tools        
                    </span>
                </a>
              </div>
            </div>
