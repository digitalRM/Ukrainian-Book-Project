  ...
  return (
    <div className="w-screen bg-[#f3f1e9] overflow-hidden ">
      <div className="w-screen h-full relative">
        <motion.svg
          className="absolute lg:flex hidden right-0 -mt-[3px]"
          width="699"
          height="282"
          viewBox="0 0 699 282"
          fill="none"
        ...
        <div id="contact" className=" py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-[590px] lg:mx-0">
              ...
              <span className={hedvigLettersSans.className}>
                <p className="mt-6 text-md sm:text-lg sm:leading-8 text-yellow-950/80">
                  Have a question or want to learn more about our project? Send
            ...
            <form
              className="mt-12 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8 sm:gap-y-8 max-w-[590px] lg:max-w-full mx-auto"
              method="Post"
