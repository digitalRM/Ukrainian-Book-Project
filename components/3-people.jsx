  ...
  return (
    <div id="members" className='w-screen bg-[#f3f1e9] overflow-hidden '>
      <div className='w-screen h-full relative'>
        <motion.svg className='absolute lg:flex hidden -right-0.5 -mt-[3px]' width="699" height="282" viewBox="0 0 699 282" fill="none" xmlns="http://www.w3.org/2000/svg">
        <motion.path
        ...
        <motion.svg className='absolute svg:flex -mr-3  hidden lg:flex right-0 bottom-0 -mb-1' width="285" height="197" viewBox="0 0 285 197" fill="none" xmlns="http://www.w3.org/2000/svg">
          <motion.path
