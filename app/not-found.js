  ...
  return (
    <>
      <main className="relative isolate min-h-full">
        ...
        />
        <div
          className="absolute inset-0 -z-10 bg-gradient-to-t from-black via-black opacity-70"
          aria-hidden="true"
        />
        <div className="mx-auto max-w-7xl px-6 py-32 text-center sm:py-56 lg:px-8">
          <p className="text-base font-semibold leading-8 text-[#f3f1e9]/90">
            404
          </p>
          <h1 className="mt-4 text-3xl font-bold text-[#f3f1e9]/90 sm:text-5xl">
            Page Not Found
          </h1>
          <p className="mt-4 text-base text-[#f3f1e9]/70 sm:mt-6">
          ...
          <div className="mt-6 flex justify-center">
            <a
              href="/"
              className="text-sm font-semibold leading-7 text-[#f3f1e9]/90"
            >
